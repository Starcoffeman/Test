...
function t_lazyload__getResizeCommand(e, t, i) {
  ...
  return e
    ...
    : "contain" === t
      ? "contain"
      : !Number.isNaN(parseFloat(n)) && !Number.isNaN(parseFloat(o))
        ? "resize"
        : "cover";
}
((window.lazy = "y"),
  ...
  (function (e, t) {
    ...
    function v(e, t, i, a) {
      ...
      if (l) {
        ...
        var b = "",
          ...
          E = !1;
        if (
          ("yes" == window.lazy_imgoptimoff && (S = !1),
          ("y" !== window.lazy_err_thumb && "y" !== window.lazy_err_static) || (S = !1),
          "IMG" !== t.tagName || d)
        )
          if (d) {
            var M = t_lazyload__getBackgroundStyles(t),
              ...
              j = M.attachment,
              B = "IMG" === t.tagName;
            ((I = t_lazyload__getResizeCommand(B, C, { x: R, y: T })),
              (b = R),
              (v = T),
              "fixed" === j && B && (E = !0));
          } else E = !0;
        ...
        if ((L = t.getAttribute("data-lazy-rule"))) {
          ...
          for (q = 0; q < P.length; q++)
            (P[q].indexOf("round:") > -1 && (N = 1 * P[q].split(":")[1]),
              P[q].indexOf("comm:") > -1 &&
                "resize" != (I = P[q].split(":")[1]) &&
                "cover" != I &&
                "contain" != I &&
                (S = !1),
              P[q].indexOf("skip") > -1 && (E = !0),
              P[q].indexOf("optimoff") > -1 && (S = !1));
        }
        if (N > 1) {
          var D = A(I, s, c, N);
          ((s = D[0]), (c = D[1]));
        ...
        if (
          ...
          !0 === S &&
            (l =
              !0 === E || s > 1e3 || c > 1e3 || 0 == s || ("IMG" != t.tagName && 0 == c)
                ? k(l)
                : O(t.tagName, I, l, s, c, b, v)),
          "y" === window.lazy_err_static && h(l) && (l = l.replace(r, "/static3.tildacdn.com/")),
          l)
        ) {
    ...
    function O(e, t, i, n, o, a, r) {
      ...
      if (
        ...
        l.indexOf(".ico") > 0 ||
        l.indexOf(".apng") > 0 ||
        -1 === l.indexOf("static.tildacdn.") ||
        l.indexOf("-/empty/") > 0 ||
        l.indexOf("-/resizeb/") > 0 ||
        l.indexOf("/-/") > -1 ||
        (0 == n && 0 == o) ||
        "y" == window.lazy_err_thumb ||
        l.indexOf("lib") > -1 ||
        ("IMG" !== e && "DIV" !== e && "TD" !== e && "A" !== e)
      )
        return i;
      var d = 1;
      ...
      var s = n,
        ...
        u,
        _;
      if ((s > 0 && (s = parseInt(d * s)), c > 0 && (c = parseInt(d * c)), s > 1e3 || c > 1800))
        return k(i);
      ...
      if ("resize" == t)
        ((_ = i.split("/")).splice(
          ...
          "-/resize/" +
            ...
            ("DIV" == e && c > 0 ? c : "") +
            "/" +
            ("y" != window.lazy_webp || x ? "" : "-/format/webp")
        ),
          (u = b(_.join("/"))));
      else {
        if (s <= 0 && c <= 0) return i;
        var f = a,
          m = r;
        ("left" !== a && "right" !== a && (f = "center"),
          "top" !== r && "bottom" !== r && (m = "center"),
          (_ = i.split("/")).splice(
            i.split("/").length - 1,
            0,
            "-/" +
    ...
    return (
      ...
      (N.prototype._showOnLoad = function (e) {
        var t,
          i = this._settings,
          n;
        function o() {
            ...
            t.forEach(function (t) {
              ...
              if (!(e._settings.skip_invisible && x(n) && n.isNotUnderScreenRange)) {
                var o = t.boundingClientRect.top + i < 0,
                  ...
                  s =
                    t.intersectionRatio >=
                    Number(n.getAttribute("data-intersection-aspect-ratio") || 0);
                if (n.wasProcessed)
                  return (
    ...
    if (null != i) {
      ...
      if ("undefined" != typeof getComputedStyle) {
        ...
        ((r = l
          ...
          (a = "-/" + t_lazyload__getResizeCommand(l, s, { x: c, y: u }) + "/"));
      } else a = "-/cover/";
      ...
      if (!(
        ...
        _.indexOf(".ico") > 0 ||
        _.indexOf(".apng") > 0 ||
        -1 === _.indexOf(t_lazyload__getThumbDomainName()) ||
        (_.indexOf("-/empty/") > 0 && _.indexOf("-/resizeb/") > 0)
      )) {
        ...
        if (x > 0 && f > 0) {
          ...
          if (
            ...
            p > 0 &&
            (m[0] > 0 || m[1] > 0) &&
            ((m[0] > 0 && g > m[0]) || (m[1] > 0 && p > m[1])) &&
            ((m[0] > 0 && g - m[0] > 100) || (m[1] > 0 && p - m[1] > 100))
          ) {
            var y =
              r.slice(0, x) + (m[0] > 0 ? g : "") + "x" + (m[1] > 0 ? p : "") + r.substring(f);
