function t396_scaleBlock(e) {
  ...
  if (l) {
    ...
    "function" == typeof window.t396__getCurrentScaleFactor
      ...
      : (a = window.tn && window.tn["ab" + e] && window.tn["ab" + e].scaleFactor) ||
      ...
      if ((t396_scale__updateArtboardState(o, i), 0 !== n.length))
        if (t396_isOnlyScalableBrowser()) t396_scale__scaleIsOnlyScalableBlock(n);
          ...
          var u = n.filter(function (e) {
            ...
            f;
          (p && t396_scale__schedule__scaleTextElements(u),
            ...
            Array.from(o.querySelectorAll(":scope > .t396__elem, :scope > .t396__group")).forEach(
              function (e) {
                var t;
  ...
  (t.write(function () {
    e.forEach(function (e) {
      ((e.elementCore.style.fontSize = ""),
        ...
        (e.cachedZoom = e.element.style.zoom),
        e.scaleFactor < 1 && (e.element.style.zoom = ""));
    });
  }),
    t.read(function () {
      e.forEach(function (e) {
        ((e.fieldFontSize = parseFloat(t396_elem__getFieldValue(e.element, "fontsize"))),
    ...
    t.write(function () {
      e.forEach(function (e) {
        ...
        var t = !isNaN(e.fieldFontSize),
          ...
          a;
        if (t ? e.fieldFontSize - e.currentFontSize >= 1 : l > 0.01) {
  ...
  t.read(function () {
    e.forEach(function (e) {
      ...
      ((l = t396_elem__getWidth(e.element, l)),
        (l = t396_elem__convertPosition__Local__toAbsolute(e.element, "width", l)));
