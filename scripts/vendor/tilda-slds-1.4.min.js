            ...
            (b.length &&
              ...
              r.getAttribute("data-slider-timeout") > 0
                ...
                : r.addEventListener("slideAutoplayTimerReady", function () {
                    r.getAttribute("data-slider-timeout") > 0 && t_slds_initAutoPlay(t, v, d, e);
                  }),
              s.querySelectorAll(".t-slds__item-loaded").length < d + 2 &&
                t_slds_UpdateImages(t, v),
              "yes" == r.getAttribute("data-slider-arrows-nearpic") && t_slds_positionArrows(t));
...
function t_slds__removeAutoplayByVideo(t) {
  var e = t.target.closest(".t-slds__item"),
    s =
      null == e
        ? void 0
        : e.querySelector("[data-slider-video-type], [data-videolazy-type], iframe");
  if (s) {
  ...
  if (!d && t && !s.querySelector('.t-slds__item[data-slide-index="' + (i + 1) + '"]')) {
    ...
    if (
      ...
      for (var y = t, v = e, g = 0; g < a - 1; g++) {
        ...
        (b.setAttribute("data-slide-index", i + g + 1),
          v.nextElementSibling.insertAdjacentElement("afterend", b),
          (v = v.nextElementSibling),
          (y = y.nextElementSibling));
      }
  }
  (o && c && (c.classList.add("t-zoomable"), c.setAttribute("data-zoomable", "yes")),
    n && _ && (_.classList.add("t-zoomable"), _.setAttribute("data-zoomable", "yes")));
}
function t_slds__hideMobileSlides(t) {
  if (t) {
    ...
    if (!s || "scroll" !== s.overflowX || "flex" !== s.display) {
      var r = "t-slds__item-innactive",
        i;
      if ((parseInt(e.getAttribute("data-slider-items-in-row"), 10) || 0) > 1) {
        var a;
        e.querySelectorAll("." + r).forEach(function (t) {
        ...
        var l = Array.prototype.slice.call(
          ...
          d = document.documentElement.clientWidth > 960 ? 5 : 3;
        if (!(l.length <= 2 * d)) {
          for (
            var o = t.getAttribute("data-slide-index"), n = [(o = parseInt(o, 10))], c = 1;
            c < d;
            c++
          )
            (o + c <= l.length ? n.push(o + c) : n.push(c),
              o - c > 0 ? n.push(o - c) : n.push(l.length + 1 - c));
        ...
        n.length &&
          Array.prototype.forEach.call(n, function (i) {
            i.addEventListener("click", function (i) {
              ...
              var a = t_slds_getCurrentTranslate(s),
                l = r.getAttribute("data-slider-animated"),
                d = parseFloat(r.getAttribute("data-slider-pos")),
                o = parseFloat(r.getAttribute("data-slider-totalslides")),
                n = r.getAttribute("data-slider-with-cycle"),
                c = "",
                _;
              "" == l &&
                ...
                "left" === this.getAttribute("data-slide-direction")
                  ...
                  : "false" == n && d == o
                    ? (d = o)
                    : d++,
                r.setAttribute("data-slider-pos", d),
                (d != o + 1 && 0 != d) || (c = "yes"),
                r.setAttribute("data-slider-cycle", c),
                t_slideMoveWithoutAnimation(t, !1, e, a));
              t_slds_updateSlider(t);
            });
          });
        ...
        if (f && 0 === r.querySelectorAll(".t-slds__item_dummy").length) {
          ...
          (y.classList.add("t-slds__item_dummy"),
            ...
            (v = r.classList.contains("js-product")
              ? r
              : r.querySelector(".t-catalog, .t-store") || r.querySelector(".js-product"))
  ...
  if (r) {
    ...
    if (i) {
      ...
      if ((a > o + 1 && (a = 1), n)) {
        ...
        (i.classList.add("t-slds_animated"), i.classList.add("t-slds_animated-cancel"));
      } else (i.classList.add("t-slds_animated"), i.classList.add("t-slds_animated-cancel"));
      (t_slideMove(t, e, s),
  ...
  if (r) {
    ...
    if (i) {
      var a = r.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)"),
        ...
        g;
      "off" === i.getAttribute("aria-live") && i.setAttribute("aria-live", "polite");
      var b = 0;
      ...
      if (
        ...
        if (y)
          if (l) {
            ...
            if ((d < u && t_slds_fadeIn(y, 300), E < u && d > 0 && (_ == E - o + 1 || E === o))) {
        ...
        (v &&
          ...
          r.querySelectorAll(".t-slds__item-loaded").length < u + 2 && t_slds_UpdateImages(t, _),
...
function t_slds_updateSlider(t) {
  ...
  if (e) {
    ...
    if (s) {
      ...
      if ((d > o + 1 && ((d = 1), s.setAttribute("data-slider-pos", 1)), c && "false" === n)) {
        var _,
          u = o - r <= 0 || d + r - 1 === o;
...
function t_slds_UpdateImages(t, e) {
  ...
  if (s) {
    ...
    r &&
      ...
      r.nextElementSibling && r.nextElementSibling.classList.add("t-slds__item-loaded"),
      r.previousElementSibling && r.previousElementSibling.classList.add("t-slds__item-loaded"));
  }
}
function t_slds_ActiveCaption(t, e, s) {
  ...
  if (r) {
    ...
    (Array.prototype.forEach.call(i, function (t) {
      ...
      0 == e
        ? (a = r.querySelector('.t-slds__caption[data-slide-caption="' + s + '"]'))
        : e == s + 1 && (a = r.querySelector('.t-slds__caption[data-slide-caption="1"]')),
...
function t_slds_scrollImages(t, e) {
  ...
  if (s) {
    ...
    s.querySelector(".t-slds__items-wrapper").style.transform = "translateX(" + r + "px)";
  }
}
  ...
  if (d) {
    ...
    if (
      ...
      (r && r.thumbsbulletGallery && e >= i && e != s + 1) || (s >= i && 0 == e)
        ? (n = d.querySelector('.t-slds__bullet[data-slide-bullet-for="' + i + '"]'))
        : 0 == e
...
function t_slds_ActiveSlide(t, e, s) {
  ...
  if (r) {
    ...
    else if (0 == e && !0 === d) l = r.querySelector('.t-slds__item[data-slide-index="' + s + '"]');
    else if (e == s + 1 && !1 === d) {
      var _ = r.querySelector('.t-slds__item[data-slide-index="1"]');
      _ && (_.classList.add("t-slds__item_active"), _.setAttribute("aria-hidden", "false"));
    } else e == s + 1 && !0 === d && (l = r.querySelector('.t-slds__item[data-slide-index="1"]'));
...
function t_slds__setTabindexForFocusableElements(t) {
  ...
  if (e) {
    ...
    if (r) {
      var i = 'a, button, input:not([type="hidden"]), select, textarea, video, iframe',
      ...
      if ((c && clearInterval(c), "true" !== d.getAttribute("data-slider-stop"))) {
        ...
        var g = setInterval(function () {
          ...
          "yes" != e &&
            "yes" != i &&
            "yes" != l &&
            ("false" == d.getAttribute("data-slider-with-cycle") && _ == s ? (_ = s) : _++,
            d.setAttribute("data-slider-pos", _),
            (_ != s + 1 && 0 != _) || (n = "yes"),
            t_slideMoveWithoutAnimation(t, !0, r, o),
            t_slds_updateSlider(t),
            "yes" == n &&
              (_ == s + 1 && (_ = 1), 0 == _ && (_ = s), d.setAttribute("data-slider-pos", _)),
      ...
      if (l) {
        ...
        if ("true" !== l.getAttribute("data-slider-stop"))
          if ("true" !== l.getAttribute("data-swiper-initialized")) {
            ...
            var u = function t(e) {
                window.pageYOffset > i.getBoundingClientRect().bottom + window.pageYOffset ||
            ...
            if (1 != e) {
              ...
              (window.removeEventListener("touchmove", m, { passive: !1 }),
                  ...
                  if (
                    ...
                    if (e.velocityX > 0.4)
                      ...
                      if (
                        ...
                        var b = i.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)"),
                          h = b[b.length - 1],
                          A = parseFloat(h.getAttribute("data-slide-index"), 10);
                        if (A < _ && c == A) {
                ...
                window.hammer.on("panend", function () {
                  (y && i.dispatchEvent(b), t_slideMove(t, !1, r), (n = !1));
                }));
            }
          }
      }
  ...
  return (
    "function" == typeof window.CustomEvent
      ...
      : ((t = document.createEvent("CustomEvent")).initCustomEvent(
        ...
        (e = document.createEvent("CustomEvent")).initCustomEvent("tildaSldsMoveSlideEnd", !0, !0)),
...
function getGalleryContainer() {
  ...
  if (t) {
    var e = t.querySelector(".t-catalog__relevants__container, .t-store__relevants__container");
    if (e) return e;
  }
  return document.querySelector(".t-catalog__relevants__container, .t-store__relevants__container");
}
function applyBaseStyles(t) {
  for (var e = t.querySelectorAll(".js-product"), s = 0; s < e.length; s++)
    for (
      var r,
        i = e[s].querySelectorAll(".t-catalog__card__textwrapper, .t-store__card__textwrapper"),
        a = 0;
      a < i.length;
      a++
    ) {
...
function updateNoImageCardHeights() {
  requestAnimationFrame(function () {
    ...
    if (!(t <= 0)) {
      ...
      if (e)
        for (var s = e.querySelectorAll(".js-product"), r = 0; r < s.length; r++) {
          var i = s[r];
  ...
  if (e) {
    ...
    t.querySelectorAll(".js-product").forEach(function (t) {
      if (
        ...
        var s = t.querySelector(".t-catalog__card__textwrapper, .t-store__card__textwrapper"),
          a = s && s.querySelector(".js-catalog-price-wrapper, .js-store-price-wrapper");
        if (s && a) {
...
function onPageshow(t) {
  t.persisted &&
    (DEBUG && console.info("Pageshow (из кэша) – инициализация галереи"), initGallery());
}
