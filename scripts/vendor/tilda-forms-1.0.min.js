...
var FORMS_API_FIELD = {
  ...
  t_formsApi__getTildaField = function t(e) {
    ...
    var r = t_formsApi__getFieldData(e),
      ...
      a = r.fieldName;
    if (!o || !n || !a)
      throw new Error("Please, set all the required data-attrs to initialize FormInput.");
    var i = function t() {
      ...
      (r.getValue = function () {
        var t,
          o = t_formsApi__safeValue(
            e.querySelector('[name="' + r.data.idInputName + '"]:not([disabled])')
          ),
          n = s.find(function (t) {
            ...
            a = r
              ...
              .map(function (e) {
                try {
                  ...
                  return r
                    ? Promise.resolve(t_formsApi__initTildaField(r)).then(function (r) {
                        return r
                          ? (t_forms__updateInputVariable(t, e, r), Promise.resolve())
                          : Promise.resolve();
                      })
                    : Promise.resolve();
                } catch (o) {
...
function t_forms__initForms() {
  ...
  Array.prototype.forEach.call(t, function (t) {
    ...
    if (!window.initForms[o]) {
      ...
      if (r && n)
        return (t_forms__onCachedPageAction(n, e), void t_forms__offInputsAutocomplete(n));
      if (
        ...
        t_forms__onClick(t),
        t_forms__onRender(t),
        n && t_forms__initFormMutationListeners(t),
...
function t_forms__initFormMutationListeners(t) {
  t &&
    (t_removeEventListener(t, "tildaform:contentchanged", t_forms__onFormContentChanged),
    t_addEventListener(t, "tildaform:contentchanged", t_forms__onFormContentChanged));
}
...
function t_forms__recalcCoverHeightByFormMutation(t) {
  ...
  if ((!e && t && t.querySelector && (e = t.querySelector("form")), e) && e.closest(".t-cover")) {
    ...
    if (o && o.id && 0 === o.id.indexOf("rec")) {
      ...
      n &&
        t_onFuncLoad("t_cover__recalcContentHeight", function () {
...
((window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language)
  .toUpperCase()
  .slice(0, 2)),
  ...
  t_onReady(function () {
    ...
    (t_forms__initForms(),
      ...
      Array.from(
        document.querySelectorAll('.t396__elem[data-elem-type="form"]:not(.zero-form-rendered)')
      ).forEach(function (t) {
    ...
    if (n || a || i) {
      ...
      if (!document.head.querySelector('script[src*="' + s + '"]')) {
        ...
        ((l.type = "text/javascript"),
          (l.src = "https://static.tildacdn." + t_forms__getRootZone() + "/js/" + s + ".min.js"),
          (l.onerror = function () {
    ...
    if ("RU" !== c && "EN" !== c) {
      ...
      if (!document.head.querySelector('script[src*="' + u + '"]')) {
        ...
        ((d.type = "text/javascript"),
          (d.src = "https://static.tildacdn." + t_forms__getRootZone() + "/js/" + u + ".min.js"),
          (d.onerror = function () {
  ...
  (window.tildaForm.validate = function (t) {
    for (
      var e,
        r = t_forms__getElement(t),
        o = r.querySelectorAll(".js-tilda-rule"),
        n = [],
        a = !0,
        i = r.getAttribute("data-formcart"),
        s,
        l = t_forms__getConditionCheckHandler(r).isHiddenByCondition,
        c = 0;
      c < o.length;
      c++
    ) {
      ...
      if (!l(u)) {
        var d = !!parseInt(u.getAttribute("data-tilda-req") || 0, 10),
          ...
          _,
          f,
          p = u.getAttribute("data-tilda-rule-minlength") || 0,
        ...
        if ((((h.length && !F) || (F && A)) && (a = !1), d && (E || (F && !A)))) v.type.push("req");
          ...
          switch (m) {
            case "email":
              ((_ =
                ...
                h.length && !h.match(_) && v.type.push("email"));
              break;
            case "url":
              if (
                ((_ =
                  /^((https?|ftp):\/\/)?[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я0-9][a-zA-Zёа-яЁА-Я\-0-9]{1,10}\/?$/gi),
                h.length)
              )
                if (
                  (f = (f = (f = h.split("//")) && f.length > 1 ? f[1] : f[0]).split("/")) &&
                  f.length &&
                  f[0]
                ) {
                  if (!(f = f[0]).match(_)) {
                    var I =
                        /^[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9]([a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\-]|xn--)*(\.[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9\-]+)+$/i,
                      j;
                    ((/xn--/.test(f) || /[^\x00-\x7F]/.test(f)) && f.match(I)) ||
                      v.type.push("url");
                  }
            ...
            case "phone":
              ...
              (D &&
                (-1 !== D.indexOf("*")
                  ? (M += "a-zёа-я")
                  : (-1 !== D.indexOf("a") && (M += "a-z"),
                    -1 !== D.indexOf("а") && (M += "а-яё"))),
                (M += "]+$"),
                (_ = new RegExp(M, "gi")),
                ((g.length && !g.match(_)) ||
                  1 == (f = g.replace(/[^0-9]+/g, "")).indexOf("000") ||
            ...
            case "name":
              ((_ =
                ...
                h.length && !h.match(_) && v.type.push("name"));
              break;
            case "nameeng":
              ((_ = /^([A-Za-z\s]{1,}((\-)?[A-Za-z\.\s](\')?){0,})*$/i),
                h.length && !h.match(_) && v.type.push("nameeng"));
              break;
            case "namerus":
              ((_ = /^([А-Яа-яЁё\s]{1,}((\-)?[А-Яа-яЁё\.\s](\')?){0,})*$/i),
                h.length && !h.match(_) && v.type.push("namerus"));
              break;
            case "string":
              ((_ =
                ...
                h.length && !h.match(_) && v.type.push("string"));
              break;
            case "chosevalue":
              var q, P, R, B, O;
              if ("SELECT" === (null == (e = u) ? void 0 : e.tagName.toUpperCase()))
                (null == (P = u) ? void 0 : P.value.length) > 0 || v.type.push("chosevalue");
              else
                "true" === (null == (B = u) ? void 0 : B.getAttribute("data-option-selected")) ||
                  v.type.push("chosevalue");
              break;
            case "promocode":
              "y" !== i ||
                !g.length ||
          ...
          (p > 0 && h.length && h.length < p && v.type.push("minlength"),
            w > 0 && h.length && h.length > w && v.type.push("maxlength"));
        }
                    ...
                    try {
                      (t_triggerEvent(form, "tildaform:aftersuccess"),
                        dataFormSendedCallback && "function" == typeof jQuery
                          ...
                          : dataFormSendedCallback && eval(dataFormSendedCallback + "(form);"));
                    } catch (error) {
...
var t_forms__setFormErrorMsg = function t(e, r) {
  e.getAttribute("data-rule-filled")
    ...
    : r &&
      ((e.innerHTML = '<a href="#" class="t-form__errorbox-link">' + r + "</a>"),
      (e.style.display = "block"));
};
...
function t_parseScripts(t, e) {
  ...
  Array.prototype.forEach.call(r, function (e) {
    ...
    if (e.innerHTML.length)
      (r.appendChild(document.createTextNode(e.innerHTML)), e.parentNode.replaceChild(r, e));
    else {
...
function t_forms__findMatchingTextNodes(t, e) {
  for (
    ...
    ["SCRIPT", "STYLE"].includes(n.parentElement.tagName) ||
      n.parentElement.classList.contains("tn-atom__inputs-textarea") ||
...
function t_forms__updateInputVariable(t, e, r) {
  var o = r.getValue,
    ...
    i = o().value;
  if (
    (n.ownVariantTitle && i && (i = i.replace(n.ownVariantTitle + ": ", "")), n.isContactMethod)
  ) {
    var s = i[e.name];
...
function t_forms__findFormField(t, e) {
  ...
  return (
    r ||
    Array.from(t.querySelectorAll('.t-input-group[data-field-name*="' + e + '"]')).find(
      function (t) {
  ...
  if ("none" !== t.style.display)
    var e = 1,
      r = setInterval(function () {
        ((t.style.opacity = e),
          (e -= 0.1) <= 0.1 &&
            (clearInterval(r), (t.style.display = "none"), (t.style.opacity = null)));
      }, 30);
}
function t_fadeIn(t) {
...
function t_forms__processFormsInPopup(t, e) {
  ...
  var n = e.closest(".t-rec"),
    ...
    i;
  "121" === a &&
    (a = t.querySelector(".t-popup__container").getAttribute("data-popup-type") || "121");
...
function t_forms__processGetParameters(t) {
  if (
    (void 0 === t && (t = {}), window.URLSearchParams && "published" === t_forms__getTildaMode())
  ) {
  ...
  return t.reduce(function (t, e) {
    if (
      ...
      var r = e.closest(".t-input-block"),
        o = Array.from(
          (null == r ? void 0 : r.querySelectorAll(".t-checkbox, .t-img-select")) || []
        );
      t.push.apply(t, o);
    } else t.push(e);
    return t;
...
function t_forms__setGetParameterToField(t, e) {
    ...
    (["checkbox", "radio"].includes(t.type)
      ? l(function () {
          ...
          s.includes(l) &&
            ...
            "radio" === t.type && t.closest(".t-contact-method__types-container") && i(r));
        })
      : "select-one" === t.type
        ? n()
        : ((t.value = e), t.classList.contains("t-range") && i(), "tel" === t.type && s()),
      l(i, !1));
  }
  function o() {
  ...
  function l(t, e) {
    ...
    var r = c();
    (e || r) &&
      (r && "y" !== r.getAttribute("data-init-calc") ? r.addEventListener("inputReady", t) : t());
  }
  function c() {
...
function t_forms__getTildaMode() {
  ...
  var t = document.getElementById("allrecords");
  return t
    ? ((window.tildamode = t.getAttribute("data-tilda-mode") || "published"), window.tildamode)
    : "notdefined";
}
