  ...
  (t && (o = 350),
    ...
    Array.prototype.forEach.call(i, function (t) {
      var i = t.getBoundingClientRect(),
        n = i.top,
        r = i.bottom;
      ((n > 0 && n < e + o) || (r > 0 && r < e + o)) && t_video_lazyload__addVideo(t);
    }));
}
function t_video_lazyload__addVideo(e) {
  var t = window.matchMedia("(max-width: 640px)").matches,
    ...
    r = n ? n.trim() : "";
  "youtube" === i && "string" == typeof r && (r = (r = r.replace(/^v=/, "")).replace(/[&?]+$/, ""));
  ...
  if (
    (e.closest(".t116, .t1148") || "540px" !== g || t_video_lazyload__setHeight(e),
    g &&
      z &&
    ...
    function q(e) {
      if (e && e.data && "string" == typeof e.data) {
        ...
        "player:ready" === t.type &&
          t.data &&
          t.data.videoId === r &&
          (window.removeEventListener("message", q), t_video__doRutubeCommand(j, "play"));
      }
    }
    (t_video__doRutubeCommand(j, "changeState"), window.addEventListener("message", q));
  }
}
...
((window.t_video__createPlayer = t_video__createPlayer),
  ...
  t_onReady(function () {
    t_onFuncLoad("t_video_lazyload_init", function () {
      var e;
      document.querySelectorAll(".t-video-lazyload:not(.t-video-no-lazyload)").length &&
