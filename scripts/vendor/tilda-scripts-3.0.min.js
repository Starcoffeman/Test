...
function t_scrollBarWidthCompensator__setObject() {
  ...
  var e = [
      ...
      "t-menu-popover__burgermenu__sidebar_right",
      ...
      (Array.prototype.forEach.call(t.fixedElements, function (e) {
        ...
        if (
          ...
          if ("fixed" === a || "absolute" === a) {
            ...
            l.indexOf("ms") + 1
              ? ((l = parseInt(l.replace("ms", ""), 10)), o.push(l))
              : l.indexOf("s") + 1 && ((l = 1e3 * parseFloat(l.replace("s", ""))), o.push(l));
            ...
            ((h =
              h ||
              n.classList.contains("t-menu-popover_fullwidth") ||
              (n.classList.contains("t-menu-popover") && u > 1)),
              (!d && 0 !== d) || "auto" === n.style.right || "absolute" === a || h
                ? h &&
                  !f &&
                  (n.style.width =
                    "calc(100vw / " + (window.isSafari ? 1 : u) + " - " + g + "px - " + m + "px)")
                : (n.style.right = m + d + "px"));
          }
        }
      }),
...
function t_scrollBarWidthCompensator__checkSize(t, e) {
  ...
  return {
    isFullscreenWidth:
      "100%" === r || "100vw" === r || a === o || a === o - e || a === o - p || a === o - p - e,
    ...
    ((a.type = "text/javascript"),
      ...
      a.addEventListener("error", function (t) {
        if (!(n <= 3)) {
          ...
          throw new Error("Failed to load " + r + " script: " + o, { cause: t });
        }
        setTimeout(function () {
          (a.remove(),
...
((window.browserLang = (window.navigator.userLanguage || window.navigator.language)
  .toUpperCase()
  .slice(0, 2)),
  ...
  t_onReady(function () {
    ...
    window.innerHeight
      ...
      : f && f.setAttribute("style", "display: block !important");
  }),
  (function () {
    function t() {
    ...
    function e() {
      ...
      for (var n = 0; n < m.length; n++) {
        ...
        (i = (o = m[n]).style).height.indexOf("vh") > -1 &&
          ((e = parseInt(i.height) / 100), (d = p * (isNaN(e) ? 1 : e) + "px"), (i.height = d));
      }
    }
    function n() {
  ...
  t_onReady(function () {
    setTimeout(function () {
      for (
        var t = document.querySelectorAll('a[href^="http"][target="_blank"]'), e = 0;
        e < t.length;
        e++
      ) {
        var n = t[e],
