...
function t396__setOverflowToAllRecords() {
  ...
  if (t) {
    ...
    (t.classList.remove("t-records__overflow-clip", "t-records__overflow-hidden"),
      t.classList.add(i ? "t-records__overflow-clip" : "t-records__overflow-hidden"));
  }
}
...
function t396__initScaleFactorFlags() {
  if (void 0 === window.shouldUseScaleFactor) {
    ...
    var t = window.navigator.userAgent.match(/Firefox\/([0-9]+)\./),
      ...
      r,
      o = ((i && parseInt(i[1], 10)) || 0) > 127 || window.t396__clientRectIncludesZoom;
    ((window.isOnlyScalable = e < 126),
      (window.shouldUseScaleFactor = !window.isOnlyScalable && !t && !o));
  }
}
            ...
            "childList" === t.type &&
              Array.from(t.addedNodes)
                ...
                .some(function (t) {
                  return (
                    3 !== t.nodeType &&
                    (t.classList.contains("t396__elem") || t.classList.contains("t396__group"))
                  );
                }) &&
              f();
          });
...
((window.t396__isMobile =
  ...
  (window.t396__isIPad =
    "ontouchend" in document && -1 !== navigator.userAgent.indexOf("AppleWebKit")),
  (window.t396__isSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent)),
  (window.t396__isTouchDevice = "ontouchend" in document),
  (window.t396__isInAppBrowser = /WebView|(iPhone|iPod|iPad)(?!.*Safari)/gi.test(
    navigator.userAgent
  )),
...
function t396__initPopupResize() {
  (document.body.removeEventListener("popupShowed", t396__handleResizeOpenedPopup),
    document.body.addEventListener("popupShowed", t396__handleResizeOpenedPopup));
}
...
function t396__clearInitialScaleStyles() {
  if ("1.0" === window.TN_SCALE_INITIAL_VER) {
    var t = function t(e) {
        var i;
        e &&
          "var(--initial-scale-height)" === e.style.getPropertyValue("height") &&
  ...
  if (t396__autoHeight__canAutocalculateHeight(t, r) && o) {
    ...
    e = r.reduce(function (e, r) {
      ...
      "window" !== t396_ab__getFieldValue(t, "upscale") ||
        ...
        t396__autoHeight__isElementPrescaled(r) ||
        (_ *= t396__getCurrentScaleFactor(t.getAttribute("data-artboard-recid")));
      return _ > e ? _ : e;
    }, -1 / 0);
  return e === -1 / 0 ? 0 : e;
}
...
function t396_ab__renderView(t) {
  if (t) {
    for (
      var e = window.tn.ab_fields, i = document.getElementById("allrecords"), r, o = 0;
      o < e.length;
      o++
    )
        ...
        case "width":
          ...
          if (
            ((c = t396_elem__getFieldValue(i, "textfit")) ||
              ("button" === d ? (c = "fixedsize") : "text" === d && (c = "autoheight")),
            ("text" === d || "button" === d) && "autowidth" === c)
          )
            return void (i.style.width = "auto");
          if (_.includes(u)) return void (i.style.width = "");
          switch (
            ((l = t396_elem__getWidth(i, l)), (i.style.width = parseFloat(l).toFixed(1) + "px"), d)
          ) {
            case "tooltip":
    ...
    case "left":
      ...
      if (
        ...
        var R = parseInt(t396_group__getFieldValue(b, "left"), 10),
          T;
        ("%" === t396_group__getFieldValue(b, "leftunits") && (R = t396_roundFloat((V * R) / 100)),
          (y -= R));
        break;
      }
      (!u && d ? "grid" === h && c && (y *= k) : (y = A + y),
        "center" === p &&
          ((S = t396_elem__getWidth(r)),
          f && "window" !== F && ((V *= k), (S *= k)),
          (y = V / 2 - S / 2 + y)),
        "right" === p &&
          ((S = t396_elem__getWidth(r)),
          f && "window" !== F && ((V *= k), (S *= k)),
          (y = V - S + y)),
        f && "window" !== F && (y += ((S = t396_elem__getWidth(r)) * k - S) / 2));
      break;
    case "top":
      var O = r.closest(".t396__artboard"),
      ...
      if (
        ((F = "grid" === h ? "grid" : "window"),
        (x = "grid" === h ? parseFloat(q) : 0),
        (I = "grid" === h ? parseFloat(H) : parseFloat(C)),
        "%" === t396_elem__getFieldValue(r, "topunits") && (y = I * (y / 100)),
        v)
      ) {
        var M = parseInt(t396_group__getFieldValue(b, "top"), 10),
          N;
        ("%" === t396_group__getFieldValue(b, "topunits") && (M = t396_roundFloat((I * M) / 100)),
          (y -= M));
        break;
      }
      (f && "window" !== F && (y *= k),
        g && "window" !== F && (x = "stretch" === l ? 0 : x / k),
        (y = x + y));
      ...
      if (
        ...
        "center" === w &&
          ...
          f &&
            "window" !== F &&
            ("stretch" !== l ? (I *= k) : (I = Z ? (Z > G ? Z : G) : O.clientHeight), (E *= k)),
          u ||
            !d ||
            c ||
            "window" === F ||
            "stretch" !== l ||
            ((I = Z ? (Z > G ? Z : G) : O.clientHeight), (I /= k)),
          (y = I / 2 - E / 2 + y)),
        "bottom" === w &&
          ((E = W(r)),
          f &&
    ...
    e.write(function () {
      i.forEach(function (t) {
        ...
        (window.t396__isSafari &&
          ...
          e &&
            !isNaN(e) &&
            (t.atom.style.setProperty("--lh-px", Math.round(e) + "px"),
            t.isRelativeLineHeight || (t.atom.style.lineHeight = Math.round(e) + "px")));
      });
    }));
}
